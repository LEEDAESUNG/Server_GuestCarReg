		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form class="login100-form validate-form flex-sb flex-w" method="post" action="login_ok.php">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "동을 입력하세요">
						<input class="input100" type="text" name="dong" placeholder="동" onfocus="this.placeholder = ''" onblur="if(this.placeholder=='')this.placeholder='동';">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-16" data-validate = "호수를 입력하세요">
						<input class="input100" type="text" name="ho" placeholder="호" onfocus="this.placeholder = ''" onblur="if(this.placeholder=='')this.placeholder='호';">
						<span class="focus-input100"></span>
					</div>
